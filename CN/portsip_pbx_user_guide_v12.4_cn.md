...
例如分机 102是队列 8000的坐席成员, 102 可以拨打 \*001\*8000 将自己状态设置为已准备好的状态，拨打 \*002*8000 将状态设置为未准备好。

如果102是多个队列的成员，并且想将自己的状态在所有的队列里都设置为准备好的状态，那么直接拨打 \*001\*即可，如果想将状态在所有的队列里都设置为未准备好的状态，拨打 \*002\*即可。
